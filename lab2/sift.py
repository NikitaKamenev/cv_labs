...
from numpy import (
    all, array, arctan2, cos, sin, exp, dot, log, logical_and, roll, sqrt, stack, trace, deg2rad,
...
def generateDoGImages(gaussian_images):
    ...
    for gaussian_images_in_octave in gaussian_images:
        dog_images_in_octave = [subtract(second_image, first_image) for first_image, second_image in zip(gaussian_images_in_octave, gaussian_images_in_octave[1:])]
...
def localizeExtremumViaQuadraticFit(i, j, image_index, octave_index, num_intervals, dog_images_in_octave, sigma, contrast_threshold, image_border_width, eigenvalue_ratio=10, num_attempts_until_convergence=5):
    ...
    for attempt_index in range(num_attempts_until_convergence):
        ...
        if not (image_border_width <= i < image_shape[0] - image_border_width and image_border_width <= j < image_shape[1] - image_border_width and 1 <= image_index <= num_intervals):
